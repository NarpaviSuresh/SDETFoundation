...
public class RemoveTargetElement {
	...
	Input: Integer array and integer target
	...
	Pseudocode:
		Declare the Integer array and Integer target
		Declare list of Integer
		traverse through the array and check if array element is not equals to target then
		Add the element to list of array
		return list
	*/
